 ...
 * Original file: /home/meng/AndroidStudioProjects/Music/snapdragonMusic/src/main/aidl/com/android/music/IMediaPlaybackService.aidl
 */
...
case TRANSACTION_getHistSize:
{
data.enforceInterface(descriptor);
int _result = this.getHistSize();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
@Override public int getHistSize() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getHistSize, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
static final int TRANSACTION_getData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
...
static final int TRANSACTION_getHistSize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_isComplete = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
}
...
public int getHistSize() throws android.os.RemoteException;
