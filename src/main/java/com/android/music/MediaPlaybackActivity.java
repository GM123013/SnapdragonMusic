...
import static com.android.music.MediaPlaybackService.mAppWidgetProviderLarge;
...
public class MediaPlaybackActivity extends Activity implements MusicUtils.Defs,
    ...
    private void setRepeatButtonImage() {
        Log.i("Music_Play","setRepeatButtonImage");
        if (mService == null)
            return;
        try {
        ...
        try {
            ...
            if ((pos >= 0) && (mDuration > 0)) {
                ...
                if (mService.isComplete() && !(pos < mDuration)) {
                    currentTimer = MusicUtils.makeTimeString(this,
                            mDuration / 1000);
                    mCurrentTime.setText(currentTimer);
                    currentProgress = mProgress.getMax();
                    mProgress.setProgress(currentProgress);
                } else {
                    currentTimer =MusicUtils
