...
public class MediaPlaybackService extends Service {
    ...
    public static final String CMDTOGGLEMODE = "togglemode";
    ...
    public static final String TOGGLEMODE_ACTION = "org.codeaurora.android.music.musicservicecommand.togglemode";
    ...
    public static MediaAppWidgetProviderLarge mAppWidgetProviderLarge =
    ...
    private Handler mMediaplayerHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case PROGRESS:
                    if (isPlaying()) {
                        mAppWidgetProviderLarge.notifyChange(MediaPlaybackService.this,META_CHANGED);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        commandFilter.addAction(TOGGLEMODE_ACTION);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            if (CMDNEXT.equals(cmd) || NEXT_ACTION.equals(action)) {
                ...
                mPausedByTransientLossOfFocus = false;
                seek(0);
            } else if (CMDTOGGLEMODE.equals(cmd) || TOGGLEMODE_ACTION.equals(action)) {
                ...
                } else if (getShuffleMode() == SHUFFLE_NORMAL) {
                    setShuffleMode(SHUFFLE_NONE);
                    setRepeatMode(REPEAT_ALL);
                }

                Log.i("Music_MediaPlaybackService", "onStartCommand():add the playmode action");
        ...
        myRegisterReceiver();
        Log.i("Music_Widget", "VOLUME_CHANGED_ACTION");
        return START_STICKY;
    }
...
//            }
    ...
    public void play() {
        ...
        if (mPlayer.isInitialized()) {
            ...
            mMediaplayerHandler.sendEmptyMessage(PROGRESS);
    ...
    private void updateNotification() {
        ...
        Log.i("Music_Widget", "updateNotification()");
        Intent modeIntent = new Intent(TOGGLEMODE_ACTION);
        PendingIntent modePendingIntent = PendingIntent.getBroadcast(this,
                0 /* no requestCode */, modeIntent, 0 /* no flags */);
        views.setOnClickPendingIntent(R.id.mode, modePendingIntent);
        viewsLarge.setOnClickPendingIntent(R.id.mode, modePendingIntent);
        ...
        if (getAudioId() < 0) {
            ...
            viewsLarge.setTextViewText(R.id.artist_album, null);
            ...
            viewsLarge.setTextViewText(R.id.artist_album, artist + "——" + album);
    ...
    public void prev() {
        synchronized (this) {
            if (mShuffleMode == SHUFFLE_NORMAL) {
                // go to previously-played track and remove it from the historyd
                int histsize = mHistory.size();
                if (histsize == 0) {
                    // prev is a no-op
                    return;
